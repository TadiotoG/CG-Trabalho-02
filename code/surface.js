    ...
    function Surface(ni, nj, ti, tj, resolutioni, resolutionj) {
        ...
        for (var i = 0; i < ni; i++) {
            for (var j = 0; j < nj; j++) {
                ...
                this.control_points[i][j] = new Dot(i * 13 + 5, 0.5 * 10, j * 13 + 5); // console.log(i + "," + j + " DOT = "+ "(" + this.control_points[i][j].x + ", " + this.control_points[i][j].y + ", " + this.control_points[i][j].z + ")")
            }
        }
