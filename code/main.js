...
function test_surface(vrp, focal_point, surface) {
    var cent = surface.get_centroide();
    var vet_vrp_minus_fp = new Vet(vrp.x - focal_point.x, vrp.y - focal_point.y, vrp.z - focal_point.z);
